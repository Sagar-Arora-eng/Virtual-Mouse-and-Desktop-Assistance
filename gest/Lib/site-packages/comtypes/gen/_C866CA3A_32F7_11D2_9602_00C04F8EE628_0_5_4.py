...
__all__ = [
    'DISPID_SRGState', 'UINT_PTR', 'SPINTERFERENCE', 'DISPID_SGRName',
    'DISPID_SASetState', 'SVP_14', 'SPWT_PRONUNCIATION',
    'SPSSuppressWord', 'SpeechEmulationCompareFlags',
    'DISPID_SAEventHandle', 'DISPID_SGRSTType', 'DISPID_SPPs_NewEnum',
    'ISpeechObjectTokenCategory', 'SVF_None', 'SAFTADPCM_11kHzMono',
    'SRAInterpreter', 'ISpeechLexiconWord',
    'DISPID_SASCurrentDevicePosition', 'ISpNotifySource',
    'SPEI_SOUND_END', 'SpeechGrammarWordType', 'ISpeechRecoContext',
    'DISPID_SOTCreateInstance', 'SpeechRecoContextState',
    'DISPID_SPRuleEngineConfidence', 'SVP_18', 'DISPID_SMSAMMHandle',
    ...
    'SAFTNoAssignedFormat', 'SP_VISEME_6', 'DISPID_SpeechVoiceEvent',
    'ISpeechFileStream', 'DISPID_SDKDeleteKey',
    'ISpPhoneticAlphabetSelection', 'SAFT24kHz16BitStereo',
    'ISpeechAudioFormat', 'DISPID_SBSRead', 'SpShortcut',
    'ISpeechObjectToken', 'DISPID_SGRSTs_NewEnum', 'eLEXTYPE_APP',
    'ISequentialStream', 'SSFMOpenForRead', 'SPAUDIOOPTIONS',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SGRSTPropertyName', 'DISPID_SMSGetData',
    'STCInprocHandler', 'LONG_PTR', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SpeechAudio', 'SAFTADPCM_8kHzMono',
    'SpeechAudioFormatType', 'SpeechStreamSeekPositionType',
    '__MIDL_IWinTypes_0009', 'STCRemoteServer',
    'DISPID_SpeechRecoContextEvents', 'SPEI_TTS_PRIVATE',
    'SAFT44kHz8BitMono', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SGRSTRule', 'SDA_Two_Trailing_Spaces', 'DISPID_SOTsItem',
    'SVP_15', 'SPAUDIOSTATUS', 'DISPID_SRGIsPronounceable',
    'DISPID_SPEDisplayText', 'SVEEndInputStream',
    'SAFT16kHz16BitStereo', 'SpMemoryStream',
    'SSSPTRelativeToCurrentPosition', 'ISpeechLexiconWords',
    'SREBookmark', 'SAFT22kHz8BitStereo', 'DISPID_SpeechPhraseRules',
    'SpMMAudioOut', 'SpeechWordType', 'DISPID_SREmulateRecognition',
    'SREFalseRecognition', 'SAFTTrueSpeech_8kHz1BitMono', 'SPPS_Verb',
    'DISPID_SPRuleConfidence', 'DISPID_SLGetWords', 'SVP_2',
    'SP_VISEME_4', 'DISPID_SRSAudioStatus', 'SPINTERFERENCE_TOOQUIET',
    'SpeechBookmarkOptions', 'SVSFPersistXML', 'SP_VISEME_5',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKDeleteValue',
    'ISpeechPhraseAlternates', 'SVP_11', 'ISpPhraseAlt',
    'SAFT22kHz16BitMono', 'SpResourceManager', 'ISpeechRecoResult',
    'DISPID_SPEAudioStreamOffset', 'SpeechStreamFileMode',
    'DISPID_SGRsAdd', 'eLEXTYPE_RESERVED6', 'SPFM_OPEN_READWRITE',
    'eLEXTYPE_PRIVATE5', 'ISpeechGrammarRuleState', 'SP_VISEME_14',
    'SpeechEngineConfidence', 'SpeechPropertyHighConfidenceThreshold',
    'ISpeechPhraseReplacement', 'SpeechGrammarTagDictation',
    'SpeechCategoryRecoProfiles', 'SPEI_RESERVED5', 'SREAdaptation',
    'ISpeechPhraseAlternate', 'DISPID_SRCEFalseRecognition',
    'SPWT_LEXICAL', 'DISPID_SRGRecoContext', 'DISPID_SPAs_NewEnum',
    'DISPID_SVAudioOutput', 'DISPID_SpeechRecoResult2',
    'eLEXTYPE_PRIVATE4', 'DISPID_SGRsFindRule', 'DISPID_SPRuleId',
    'DISPID_SRGetRecognizers', 'SPEI_TTS_BOOKMARK',
    'SAFTGSM610_22kHzMono', 'SRSInactiveWithPurge', 'SpVoice',
    'DISPID_SVGetAudioInputs', 'SVP_5', 'ISpPhrase',
    'SpeechRuleState', 'eLEXTYPE_PRIVATE20', 'SPSHORTCUTPAIRLIST',
    'SpeechRetainedAudioOptions', 'SP_VISEME_2',
    'DISPID_SpeechLexicon', 'SpeechAudioState',
    'DISPID_SpeechVoiceStatus', 'SVPNormal', 'DISPID_SRCResume',
    'SPEI_HYPOTHESIS', 'ISpPhoneticAlphabetConverter',
    'DISPID_SGRInitialState', 'SAFT22kHz8BitMono',
    'DISPID_SpeechCustomStream', 'DISPID_SVEWord',
    'DISPID_SGRAddState', 'DISPID_SRSetPropertyString',
    'SpNullPhoneConverter', 'SPPS_RESERVED2', 'DISPID_SPELexicalForm',
    'DISPID_SGRSTNextState', 'ISpeechVoice', 'SPLO_STATIC',
    'SPBO_TIME_UNITS', 'DISPID_SOTMatchesAttributes',
    'SpeechCategoryRecognizers', 'DISPID_SpeechPhoneConverter',
    'ISpeechAudio', 'SPEI_RECO_OTHER_CONTEXT', 'ISpeechAudioStatus',
    'SAFTDefault', 'SPRECOSTATE', 'ISpeechPhraseElements',
    'DISPID_SPIRule', 'SpeechGrammarTagUnlimitedDictation',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE14', 'SPSVerb',
    'SSFMOpenReadWrite', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPEAudioTimeOffset',
    'SAFTCCITT_ALaw_11kHzStereo', 'SVP_19',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SASFreeBufferSpace', 'SAFT8kHz8BitStereo',
    'SPRECOGNIZERSTATUS', 'SPLO_DYNAMIC', 'DISPID_SPPValue',
    'DISPID_SRRTTickCount', 'DISPID_SRGCmdLoadFromObject',
    ...
    'SpUnCompressedLexicon', 'SWTDeleted', 'SP_VISEME_13',
    'DISPID_SOTGetDescription', 'DISPID_SASNonBlockingIO',
    'DISPID_SVSInputWordPosition', 'SAFT32kHz16BitMono',
    'SAFT44kHz8BitStereo', 'SAFT48kHz8BitStereo',
    'DISPID_SRCEPhraseStart', 'SPCT_SUB_COMMAND',
    'DISPID_SRGDictationUnload', 'eLEXTYPE_PRIVATE6',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SRAImport',
    'DISPID_SLPPhoneIds', 'SpeechAddRemoveWord',
    'DISPID_SRCSetAdaptationData', 'ISpeechPhraseReplacements',
    'DISPID_SpeechLexiconProns', 'SpPhraseInfoBuilder',
    'IEnumSpObjectTokens', 'DISPID_SPRNumberOfElements', 'SGRSTTWord',
    'IStream', 'SPEVENTENUM', 'DISPID_SRGCommit', 'SRTStandard',
    'ISpRecoGrammar', 'SREPropertyStringChange', 'SECFIgnoreWidth',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPIRetainedSizeBytes',
    'SpCompressedLexicon', 'SPDKL_DefaultLocation',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechLexiconWord',
    'DISPID_SLWType', 'SPEI_PROPERTY_STRING_CHANGE', 'SPRULESTATE',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRSTsCount',
    'DISPID_SVSLastResult', 'SPEI_SR_BOOKMARK', 'SP_VISEME_19',
    'SVSFParseSsml', 'SPSHORTCUTPAIR', 'ISpeechPhoneConverter',
    'DISPID_SRGReset', 'SVP_4', 'ISpeechPhraseProperty',
    'eWORDTYPE_ADDED', 'DISPID_SRCEHypothesis', 'SSSPTRelativeToEnd',
    'DISPID_SPEAudioSizeBytes', 'SVEBookmark', 'DISPID_SDKEnumValues',
    'Speech_Max_Pron_Length', 'DISPID_SPRText',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTText',
    'ISpeechRecoGrammar', 'SVP_20', 'DISPID_SGRSTPropertyId',
    'SAFTCCITT_uLaw_11kHzMono', 'SPBINARYGRAMMAR',
    'eLEXTYPE_RESERVED10', 'DISPID_SPAPhraseInfo', 'ISpRecoContext',
    'DISPID_SLPPartOfSpeech', 'ISpResourceManager',
    'SAFT8kHz16BitMono', 'SAFT8kHz16BitStereo', 'eLEXTYPE_PRIVATE2',
    'SpeechCategoryAudioIn', 'SDTAlternates', 'tagSTATSTG',
    'ISpEventSource', 'STCAll', 'SPWORDTYPE', 'SDTPronunciation',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVStatus',
    'DISPID_SRRRecoContext', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SLWWord',
    'ISpRecoCategory', 'DISPID_SOTCategory', 'eWORDTYPE_DELETED',
    'SRCS_Enabled', 'SPRST_NUM_STATES', 'DISPID_SDKGetStringValue',
    'SLTApp', 'SPDKL_CurrentConfig', 'SDTAll',
    'DISPID_SLRemovePronunciationByPhoneIds', '_RemotableHandle',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SpeechFileStream', 'DISPID_SOTCEnumerateTokens',
    'SITooFast', 'SPEVENTSOURCEINFO', 'SGRSTTEpsilon',
    'DISPID_SRRTLength', 'DISPID_SVEStreamStart',
    'SECNormalConfidence', 'SPPS_Modifier', 'SPEI_SR_PRIVATE',
    'SLODynamic', 'SECHighConfidence', 'SSTTDictation',
    'DISPID_SpeechGrammarRuleState', 'SAFT12kHz16BitStereo',
    'SPPS_Noncontent', 'SPWORDPRONUNCIATION', 'SGDisplay',
    'SpeechVisemeType', 'SP_VISEME_11', 'SPBO_PAUSE',
    'DISPID_SRCEEnginePrivate', 'SVP_9', 'SAFTText',
    'SDKLCurrentConfig', 'DISPID_SABIMinNotification',
    'DISPID_SABIBufferSize', 'SpeechRegistryUserRoot',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPINTERFERENCE_NOISE',
    'SVEPrivate', 'eLEXTYPE_PRIVATE11', 'DISPID_SGRsCommit',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFIsFilename',
    'SpeechInterference', 'DISPID_SLPType', 'SAFTADPCM_22kHzMono',
    'STSF_AppData', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSFunction',
    'SGSExclusive', 'DISPID_SBSSeek', 'eLEXTYPE_PRIVATE17',
    'eLEXTYPE_PRIVATE12', 'SAFT48kHz16BitMono', 'SVEWordBoundary',
    'DISPIDSPRG', 'ISpeechRecognizer',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    '_ISpeechRecoContextEvents', 'SREStreamStart', 'SPAR_Unknown',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SLPs_NewEnum', 'SpStream', 'DISPID_SBSWrite',
    'SRTSMLTimeout', 'SAFT11kHz16BitMono', 'SVSFParseSapi',
    'SPEI_RESERVED6', 'DISPID_SLAddPronunciation',
    'SpSharedRecognizer', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SRCRecognizer', 'SP_VISEME_0', 'SPFILEMODE',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPPId', 'SINone', 'SREPrivate',
    'SPSNoun', 'SPEI_SENTENCE_BOUNDARY', 'DISPID_SVEAudioLevel',
    'DISPID_SBSFormat', 'SREPropertyNumChange', 'ISpStreamFormat',
    'IEnumString', 'SPDATAKEYLOCATION', 'SPPHRASEPROPERTY',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRIsShared',
    'SAFTGSM610_8kHzMono', 'DISPID_SVSPhonemeId',
    'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpeechDiscardType',
    'SpeechAudioVolume', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGSetTextSelection', 'SPGS_EXCLUSIVE',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechDataKey',
    'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE7', 'SINoise', 'SGSEnabled',
    'SPGRAMMARSTATE', 'ISpObjectTokenCategory', 'SPSMF_UPS',
    'DISPID_SRRSetTextFeedback', 'SGDSActiveUserDelimited',
    'DISPID_SRCEAudioLevel', 'ISpeechObjectTokens',
    'DISPID_SWFEExtraData', 'DISPID_SGRClear', 'SP_VISEME_18',
    'SRERecoOtherContext', 'ISpSerializeState', 'SRCS_Disabled',
    'DISPID_SRSSupportedLanguages', 'SPPS_RESERVED4', 'SASPause',
    'SAFT8kHz8BitMono', 'SVEAllEvents', 'SPEI_START_INPUT_STREAM',
    'SRSActive', 'DISPID_SPACommit', 'DISPID_SVIsUISupported',
    'DISPID_SRState', 'DISPID_SVVolume', 'SVP_0', 'SP_VISEME_7',
    'SDTRule', 'DISPID_SRCESoundStart', 'ISpRecognizer3',
    'DISPID_SRGRules', 'DISPID_SVEBookmark',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCVoice', 'DISPID_SGRSRule',
    'DISPID_SVSpeakCompleteEvent', 'SpeechPropertyResponseSpeed',
    'DISPID_SVEventInterests', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPPS_Function', 'ISpeechLexiconPronunciation', 'SpMMAudioEnum',
    'SAFTGSM610_11kHzMono', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechRunState', 'DISPID_SPRulesItem', 'DISPID_SRRGetXMLResult',
    'DISPID_SRGCmdLoadFromMemory', 'SPADAPTATIONRELEVANCE', 'SVP_7',
    'DISPID_SLWsCount', 'ISpGrammarBuilder',
    'DISPID_SABufferNotifySize', 'SPCT_DICTATION',
    'DISPID_SpeechGrammarRule', 'SPPHRASEELEMENT', 'SPWF_INPUT',
    'SP_VISEME_15', 'IInternetSecurityMgrSite',
    'SAFTADPCM_11kHzStereo', 'SPPS_RESERVED1',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVSInputSentenceLength',
    'ISpeechBaseStream', 'SP_VISEME_8',
    'SpeechDictationTopicSpelling', 'DISPID_SPRules_NewEnum',
    'DISPID_SPPChildren', 'SPSHT_NotOverriden',
    'ISpeechRecoResultDispatch', 'eLEXTYPE_PRIVATE13',
    'ISpeechRecoResult2', 'DISPID_SpeechAudioStatus', 'DISPID_SRGId',
    'DISPID_SRGDictationLoad', 'SpeechGrammarState',
    'SpeechCategoryPhoneConverters', 'SDKLCurrentUser',
    'DISPID_SVSVisemeId', 'DISPID_SVSLastStreamNumberQueued',
    'SpeechRecognizerState', 'SVSFVoiceMask', 'DISPID_SOTCSetId',
    'DISPID_SAVolume', 'SPXMLRESULTOPTIONS',
    'DISPID_SDKSetBinaryValue', 'DISPID_SABufferInfo',
    'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_1', 'SPAS_PAUSE',
    'SpInProcRecoContext', 'DISPID_SVEVoiceChange', 'SVEPhoneme',
    'DISPID_SCSBaseStream', 'DISPID_SPAsItem', 'DISPID_SPEsCount',
    'ISpEventSink', 'ISpeechRecognizerStatus',
    'SDA_One_Trailing_Space', 'DISPID_SLPSymbolic', 'SPEVENT',
    'SPEI_RECOGNITION', 'DISPID_SPCPhoneToId', 'SVSFUnusedFlags',
    'SAFT32kHz16BitStereo', 'eLEXTYPE_USER', 'DISPID_SVSpeak',
    'SpeechTokenIdUserLexicon', 'ISpStream', 'SINoSignal',
    'DISPID_SPIReplacements', 'SPSHT_OTHER', 'DISPID_SDKSetLongValue',
    'SVSFParseAutodetect', 'DISPID_SPRDisplayAttributes',
    'SPBO_AHEAD', 'ISpeechGrammarRules', 'SBOPause',
    'SpPhoneConverter', 'SAFT48kHz16BitStereo', 'DISPID_SPEs_NewEnum',
    'SPEI_WORD_BOUNDARY', 'DISPID_SOTCGetDataKey',
    'DISPID_SGRSTPropertyValue', 'DISPID_SpeechMMSysAudio',
    'SAFT24kHz16BitMono', 'SPPS_Interjection', 'DISPID_SOTDisplayUI',
    'ISpRecoGrammar2', 'ISpAudio', 'SPEI_ADAPTATION',
    'DISPID_SVSpeakStream', 'SVSFlagsAsync', 'DISPID_SRRPhraseInfo',
    'ISpeechResourceLoader', 'SPVOICESTATUS', 'SpeechVisemeFeature',
    'DISPID_SVPriority', 'ISpPhoneConverter', 'eLEXTYPE_RESERVED4',
    'SpeechDataKeyLocation', 'ISpeechPhraseRule',
    'ISpeechPhraseInfoBuilder', 'SPXRO_SML',
    'DISPID_SPIAudioSizeTime', 'ISpeechRecoResultTimes',
    'DISPID_SPPEngineConfidence', 'SPEI_END_SR_STREAM',
    'DISPID_SWFEFormatTag', 'SpeechFormatType',
    'SPEI_START_SR_STREAM', 'DISPID_SOTDataKey', 'SP_VISEME_17',
    'SPCS_ENABLED', 'DISPID_SVESentenceBoundary',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechRecoResult',
    'SPSInterjection', 'SFTInput', 'DISPID_SFSClose',
    'SREInterference', 'DISPID_SPERequiredConfidence',
    'DISPID_SRRecognizer', 'SRADynamic', 'SECFDefault',
    'SpeechAudioFormatGUIDWave', 'SRSEIsSpeaking',
    'DISPID_SpeechBaseStream', 'SPRS_ACTIVE_USER_DELIMITED',
    'SREStreamEnd', 'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPEsItem',
    'SP_VISEME_3', 'SAFT16kHz16BitMono', 'ISpeechPhraseInfo',
    'DISPID_SPIAudioSizeBytes', 'eLEXTYPE_PRIVATE10', 'SP_VISEME_12',
    'SPCT_SLEEP', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRGSetWordSequenceData', 'SpeechAudioFormatGUIDText',
    'DISPID_SOTCDefault', 'SVSFDefault', 'SGPronounciation',
    'DISPID_SpeechObjectTokens', 'SPPHRASERULE', 'SPCT_SUB_DICTATION',
    'SPXRO_Alternates_SML', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SVGetProfiles',
    'DISPID_SpeechRecognizer', 'DISPID_SAStatus',
    'SPTEXTSELECTIONINFO', 'SpeechPropertyLowConfidenceThreshold',
    'SGRSTTWildcard', 'DISPID_SLWLangId',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCreateRecoContext', 'SPPS_Unknown', 'SGDSInactive',
    'DISPID_SVAlertBoundary', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRRSaveToMemory', 'ISpMMSysAudio',
    'DISPID_SRCEAdaptation', 'DISPID_SOTIsUISupported',
    '_ISpeechVoiceEvents', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRRAudioFormat', 'DISPIDSPTSI_ActiveLength',
    'SGSDisabled', 'SRESoundStart', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechRecoResultTimes',
    'ISpStreamFormatConverter', 'SRERecognition', 'SPSLMA',
    'DISPID_SVSRunningState', 'ISpeechLexiconPronunciations',
    'SVESentenceBoundary', 'DISPID_SRCCreateGrammar', 'SpLexicon',
    'eLEXTYPE_RESERVED9', 'DISPID_SVWaitUntilDone', 'SVP_13',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRulesCount', 'DISPID_SRProfile', 'SVSFNLPMask',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPAUDIOBUFFERINFO',
    'Speech_StreamPos_RealTime', 'SITooQuiet', 'eLEXTYPE_PRIVATE16',
    'SDTReplacement', 'DISPID_SPERetainedStreamOffset',
    'SpeechTokenContext', 'SREStateChange',
    'DISPID_SpeechPhraseProperty', 'DISPID_SpeechGrammarRules',
    'SVP_10', 'SSFMCreateForWrite', 'DISPID_SOTGetAttribute',
    'SVSFIsXML', 'SAFT22kHz16BitStereo', 'SpeechCategoryAudioOut',
    'SpeechVoiceSpeakFlags', 'SP_VISEME_10',
    'DISPID_SRGetPropertyNumber', 'SPEI_UNDEFINED',
    'SpeechUserTraining', 'SpeechAllElements', 'SRTExtendableParse',
    'SVEStartInputStream', 'SpeechRecoProfileProperties',
    'DISPID_SRCRetainedAudioFormat', 'SPEI_RECO_STATE_CHANGE',
    'SPRST_ACTIVE', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPRuleNumberOfElements', 'SDTDisplayText',
    'DISPID_SDKEnumKeys', 'SPEI_RESERVED3',
    'DISPID_SpeechPhraseReplacements',
    'DISPID_SVSInputSentencePosition', 'SpeechRecoEvents',
    'SPWORDLIST', 'DISPID_SLRemovePronunciation', 'SPPS_NotOverriden',
    'SVEViseme', 'SAFT44kHz16BitMono', 'DISPID_SLPLangId',
    'DISPID_SpeechAudioBufferInfo', 'SpeechVoiceEvents', 'SRAExport',
    'SPSMF_SAPI_PROPERTIES', 'SpeechRegistryLocalMachineRoot',
    'SP_VISEME_21', 'SPBO_NONE', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRCState', 'DISPID_SPIEngineId', 'SVP_16',
    'SPSNotOverriden', 'SPSEMANTICFORMAT', 'DISPID_SRRSpeakAudio',
    'SPPARTOFSPEECH', 'DISPID_SpeechXMLRecoResult',
    'SAFTCCITT_uLaw_44kHzStereo', 'SAFTCCITT_uLaw_22kHzMono',
    'SDTProperty', 'DISPID_SpeechRecoContext', 'SPEI_REQUEST_UI',
    'SPFM_CREATE_ALWAYS', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechSpecialTransitionType', 'SPVPRI_ALERT',
    'DISPID_SRSetPropertyNumber', 'DISPID_SDKSetStringValue',
    'DISPID_SMSADeviceId', 'SpCustomStream', 'SpFileStream',
    'SVSFNLPSpeakPunc', 'SPCONTEXTSTATE', 'SpNotifyTranslator',
    'SSSPTRelativeToStart', 'SASClosed', 'DISPIDSPTSI',
    'ISpeechVoiceStatus', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPDKL_CurrentUser', 'SVEVoiceChange',
    'ISpeechGrammarRuleStateTransition', 'SRAORetainAudio',
    'SPRST_INACTIVE', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPCIdToPhone', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SPPParent', 'SPCATEGORYTYPE', 'DISPID_SPEPronunciation',
    'DISPID_SPPFirstElement', 'DISPID_SFSOpen',
    'IInternetSecurityManager', 'SPWT_DISPLAY',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCEInterference',
    'SPEI_END_INPUT_STREAM', 'DISPID_SpeechMemoryStream',
    'DISPID_SLPsItem', 'DISPID_SPPsCount', 'SASStop',
    'DISPID_SVEStreamEnd', 'SPGS_ENABLED',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE18',
    'SPAR_Medium', 'SPGRAMMARWORDTYPE', 'DISPID_SGRsDynamic',
    'DISPID_SAFGuid', 'SPCT_COMMAND', 'DISPID_SpeechPhraseRule',
    'eLEXTYPE_PRIVATE8', 'SPSHT_EMAIL', 'SPVPRIORITY',
    'SpInprocRecognizer', 'SPAUDIOSTATE',
    'DISPID_SPEEngineConfidence', 'DISPID_SOTRemoveStorageFileName',
    'ISpRecoResult', 'DISPID_SGRSTransitions', 'DISPID_SLWsItem',
    'DISPID_SRCRetainedAudio', 'DISPID_SMSALineId',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPEDisplayAttributes',
    'SPSHORTCUTTYPE', 'DISPID_SGRSTsItem', 'SPSERIALIZEDRESULT',
    'Speech_Default_Weight', 'SAFT11kHz8BitMono', 'DISPID_SLPsCount',
    'SVPAlert', 'SPEI_PHRASE_START', 'DISPID_SWFEChannels',
    'SpObjectTokenCategory', 'SPEI_VOICE_CHANGE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVSFIsNotXML', 'SRESoundEnd',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRCBookmark', 'SPSTREAMFORMATTYPE',
    'SpeechVoicePriority', 'SVF_Stressed',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPEI_PHONEME',
    'SpSharedRecoContext', 'SAFT11kHz8BitStereo', 'SASRun',
    'SREPhraseStart', 'eLEXTYPE_RESERVED8', 'ISpXMLRecoResult',
    'SAFT32kHz8BitMono', 'SpStreamFormatConverter', 'SPLEXICONTYPE',
    'SPRECORESULTTIMES', 'ISpeechAudioBufferInfo',
    'DISPID_SPRuleParent', 'SAFTNonStandardFormat', 'SITooSlow',
    'SECFIgnoreCase', 'DISPID_SVRate', 'SPPHRASEREPLACEMENT',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SLWs_NewEnum',
    'DISPID_SRAudioInputStream', 'SPSEMANTICERRORINFO', 'SPAS_RUN',
    'SAFTExtendedAudioFormat', 'DISPID_SLGetGenerationChange',
    'SpeechEngineProperties', 'DISPID_SGRAttributes',
    'ISpObjectToken', 'SPEI_MAX_TTS', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRAudioInput', 'SAFT11kHz16BitStereo',
    'tagSPPROPERTYINFO', 'SPEI_MIN_SR', 'DISPID_SRRDiscardResultInfo',
    'SGRSTTDictation', 'DISPID_SpeechObjectToken',
    'SpeechPartOfSpeech', 'ISpeechPhraseElement', 'SECFEmulateResult',
    'Speech_StreamPos_Asap', 'SDA_No_Trailing_Space', 'SGLexical',
    'SPVISEMES', 'DISPID_SRSCurrentStreamNumber',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SGRAddResource',
    'DISPID_SRDisplayUI', 'ISpeechGrammarRuleStateTransitions',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRGCmdSetRuleState',
    'SPAS_STOP', 'DISPID_SPIAudioStreamPosition', 'SPAO_NONE',
    'Speech_Max_Word_Length', 'DISPID_SPIGetText', 'SPVPRI_NORMAL',
    'SP_VISEME_20', 'SPSUnknown', 'DISPID_SPPConfidence',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCERecognition',
    'eLEXTYPE_PRIVATE19', 'STSF_LocalAppData',
    'SpeechPropertyAdaptationOn', 'SRATopLevel',
    'DISPID_SVGetAudioOutputs', 'SWTAdded', 'SAFTADPCM_44kHzMono',
    'SRTReSent', 'eLEXTYPE_PRIVATE9', 'DISPID_SRGetFormat',
    'DISPID_SRGCmdLoadFromResource', 'SPLOADOPTIONS',
    'DISPID_SPRsItem', 'SPVPRI_OVER', 'ISpRecognizer2',
    'eLEXTYPE_PRIVATE15', 'DISPID_SGRId', 'ISpRecoContext2',
    'SPSModifier', 'SPEI_MIN_TTS', 'SPGS_DISABLED', 'SVEAudioLevel',
    'STCInprocServer', 'DISPID_SOTGetStorageFileName', 'SPEI_VISEME',
    'ISpNotifyTranslator', 'DISPID_SRCPause', 'SPPS_LMA',
    'SPEI_MAX_SR', 'DISPID_SABIEventBias', 'SpeechTokenKeyUI',
    'DISPID_SPRuleChildren', 'SAFT16kHz8BitMono', 'SVP_1',
    'ISpeechGrammarRule', 'SGRSTTTextBuffer', 'SpeechLoadOption',
    'DISPID_SPRsCount', 'DISPID_SLWPronunciations',
    'SAFT24kHz8BitMono', 'SAFT32kHz8BitStereo',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SGRSAddWordTransition',
    'SAFTCCITT_uLaw_22kHzStereo', 'SAFTADPCM_44kHzStereo',
    'DISPID_SAFType', 'ISpObjectWithToken', 'DISPID_SVGetVoices',
    'DISPID_SVEPhoneme', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SRADefaultToActive', 'ISpeechLexicon', 'SLOStatic',
    'SP_VISEME_16', 'DISPID_SPCLangId', 'SREAllEvents',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SWFEBlockAlign',
    'SVP_17', 'DISPID_SWFEBitsPerSample', 'ISpeechMemoryStream',
    'SVP_6', 'SVSFPurgeBeforeSpeak', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechMMSysAudio', 'SpMMAudioIn',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SRCERequestUI',
    'ISpRecognizer', 'SAFTCCITT_uLaw_44kHzMono',
    ...
    'SPFM_NUM_MODES', 'DISPID_SPIStartTime', 'DISPID_SVSkip',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SOTs_NewEnum',
    'SpeechGrammarTagWildcard', 'DISPID_SVVoice', 'SRSActiveAlways',
    'ISpLexicon', 'SGRSTTRule', 'ISpeechXMLRecoResult',
    ...
    'DISPID_SPIElements', 'DISPID_SLGetPronunciations', 'SRARoot',
    'SGLexicalNoSpecialChars', 'SPSHT_Unknown', 'DISPID_SOTId',
    'SREAudioLevel', 'DISPID_SOTCId', 'SAFT44kHz16BitStereo',
    'DISPID_SRIsUISupported', 'ISpeechCustomStream', 'SITooLoud',
    'DISPID_SpeechPhraseAlternate', 'SRSInactive',
    'SpeechVoiceSkipTypeSentence', 'SVPOver', 'DISPID_SVResume',
    'SpeechCategoryVoices', 'SPWORD', 'SPPS_RESERVED3',
    'DISPID_SPARecoResult', 'SpPhoneticAlphabetConverter',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SPAsCount',
    'DISPID_SLGenerationId', 'DISPID_SPPName',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SAFGetWaveFormatEx',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVSCurrentStreamNumber',
    'SECFNoSpecialChars', 'DISPID_SDKCreateKey', 'SVP_12',
    'SSTTTextBuffer', 'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRsCount',
    'SVSFParseMask', 'WAVEFORMATEX', 'SDTAudio', 'SECLowConfidence',
    'SSFMCreate', 'ISpShortcut', 'DISPID_SpeechAudioFormat',
    'SAFT48kHz8BitMono', 'DISPID_SpeechPhraseProperties',
    'SAFTADPCM_22kHzStereo', 'DISPID_SDKGetlongValue',
    'SPEI_RESERVED2', 'SpeechTokenKeyAttributes',
    'ISpeechPhraseRules', 'SBONone', 'SpWaveFormatEx',
    '_SPAUDIOSTATE', 'DISPID_SGRsCommitAndSave', 'SECFIgnoreKanaType',
    'DISPID_SVDisplayUI', 'SpeechLexiconType',
    'DISPID_SRSNumberOfActiveRules', 'SPPROPERTYINFO',
    'DISPID_SRSClsidEngine', 'DISPID_SGRs_NewEnum', 'SRSEDone',
    'SPFM_OPEN_READONLY', 'DISPID_SPRs_NewEnum', 'ISpVoice',
    'SLTUser', 'DISPID_SGRSTWeight', 'SREHypothesis',
    'SAFT12kHz8BitMono', 'DISPID_SRRTStreamTime',
    'DISPID_SpeechRecognizerStatus', 'SRTEmulated',
    'ISpeechPhraseProperties', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SWFESamplesPerSec', 'SAFT16kHz8BitStereo', 'SVP_21',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SVSInputWordLength', 'DISPID_SRStatus',
    'STSF_CommonAppData', 'SPEI_TTS_AUDIO_LEVEL', 'ISpNotifySink',
    'SRERequestUI', 'DISPID_SRCEBookmark', 'SPPS_SuppressWord',
    'SPPS_Noun', 'DISPID_SGRsItem', 'SGDSActiveWithAutoPause',
    ...
    'DISPID_SDKOpenKey', 'SPPHRASE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SpeechPhraseElement', 'SVP_3', 'SVP_8', 'SPAR_High',
    'SPAS_CLOSED', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SDKGetBinaryValue', 'SAFTGSM610_44kHzMono',
    'DISPID_SVPause', 'SpeechRecognitionType', 'SPAR_Low',
    'SPFM_CREATE', 'DISPID_SRRTimes', 'SPWAVEFORMATTYPE',
    'SPRECOCONTEXTSTATUS', 'SPRS_ACTIVE',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRRAlternates', 'DISPID_SADefaultFormat',
    'SpeechRuleAttributes', 'DISPID_SpeechPhraseElements',
    'SpeechAudioProperties', 'SPDKL_LocalMachine',
    'SPINTERFERENCE_NONE', 'DISPID_SpeechPhraseInfo',
    ...
    'SAFTCCITT_uLaw_8kHzMono', 'SDTLexicalForm', 'SPWF_SRENGINE',
    'SRTAutopause', 'DISPID_SVSLastBookmark', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPPNumberOfElements', 'DISPID_SOTsCount',
    'DISPID_SVSLastBookmarkId', 'SDKLDefaultLocation',
    'DISPID_SRRAudio', 'DISPID_SPILanguageId', 'STCLocalServer',
    'SPCS_DISABLED', 'SpTextSelectionInformation', 'STSF_FlagCreate',
    'DISPID_SRCESoundEnd', 'DISPID_SPPsItem', 'DISPID_SVEViseme',
    'SpeechTokenKeyFiles', 'SAFT12kHz16BitMono', 'SRAONone',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SRGetPropertyString', 'ISpProperties', 'ISpeechDataKey',
    'SpeechTokenValueCLSID', 'SPEI_INTERFERENCE', 'DISPID_SPRuleName',
    'DISPID_SRCEventInterests', 'DISPID_SOTSetId',
    'SpeechMicTraining', 'DISPID_SpeechObjectTokenCategory',
    'SFTSREngine', 'ISpeechWaveFormatEx', 'DISPID_SRCEEndStream',
    'eLEXTYPE_LETTERTOSOUND', 'SPRULE', 'SpeechWordPronounceable',
    'SPBOOKMARKOPTIONS', 'SDKLLocalMachine', 'DISPID_SASState',
    'DISPID_SVAudioOutputStream'
]

_check_version('1.2.0', 1633528316.302569)
